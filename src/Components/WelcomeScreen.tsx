"use client"
import React, {ForwardRefExoticComponent, RefAttributes, SVGProps, useEffect, useState} from 'react';
                ...
                >
                    ...
                    <span data-aos="fade-up" data-aos-delay="800" className="inline-block px-2 bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">
                      ...
                      Design
                            ...
                            >
                                <a
                                    href="www.linkedin.com/in/stefan-loish-965809347"
                      ...
                      <TypewriterEffect text="slysl.avito.redesign" />
                    </span>
                                    </div>
                                </a>
                            </motion.div>
